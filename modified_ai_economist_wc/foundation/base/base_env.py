...
from modified_ai_economist_wc.foundation.base.base_agent import agent_registry
from modified_ai_economist_wc.foundation.base.registrar import Registry
from modified_ai_economist_wc.foundation.base.world import World
from modified_ai_economist_wc.foundation.base.base_component import component_registry
from modified_ai_economist_wc.foundation.entities.endogenous import endogenous_registry
from modified_ai_economist_wc.foundation.entities.landmarks import landmark_registry
from modified_ai_economist_wc.foundation.entities.resources import resource_registry
...
class BaseEnvironment(ABC):
    ...
    Example:
        ...
        # see ../scenarios/simple_wood_and_stone_and_iron_and_soil/vote_and_invest_scenario.py
        UniScenarioClass = foundation.scenarios.get("uniform/simple_wood_and_stone_and_iron_and_soil")

        # see ../components/move.py and ../components/continuous_double_auction.py and ../components/vote_and_invest_component.py and ../components/communication_and_build_component.py
        GatherComponentClass = foundation.components.get("Gather")
        VoteInvestComponentClass = foundation.components.get("ContinuousDoubleAuction")
        ...
        CommunicateComponentClass = foundation.components.get("CommunicateBuild")
    ...
    Example:
        ...
        env = ScenarioClass(
            components=[
                ...
                ("CommunicateBuild", {"payment": 10, "payment_max_skill_multiplier": np.array([5, 5, 10, 10])}),
            ],
            n_agents=6,
            world_size=[40, 40],
        )
    ...
    def __init__(
        ...
        self._entities = {
            "resources": ["Coin"],
            "landmarks": [],
            "endogenous": ["Labor", "VoteInvest", "Communication"],
        }
