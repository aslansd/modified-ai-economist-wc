...
class BaseAgent:
    ...
    def action_spaces(self):
        ...
        if self.multi_action_mode == True:
            ...
            Example:
                ...
                [5, 25, 5]
                >> self._action_names
                ["Gather", "VoteInvest", "Communicate"]
                # [4 Gather actions + Gather NO-OP, 24 VoteInvest actions + VoteInvest NO-OP, 4 Communicate action + Communicate NO-OP]
        ...
        if self.multi_action_mode == False:
            ...
            Example:
                ...
                >> self._action_names
                ["Gather", "VoteInvest", "Communicate"]
                # 1 NO-OP + 4 Gather actions + 24 VoteInvest actions + 4 Communicate action
        """
    ...
    def endogenous(self):
        ...
        Example:
            >> self.endogenous
            {"Labor": 30.25, "VoteInvest": [1.0, 2.0, 3.0], "Communication": ['a', 'b', 'c', 'd']}
        """
    ...
    def inventory(self):
        ...
        Example:
            >> self.inventory
            {"Wood": 3, "Stone": 20, "Iron": 5, "Soil": 10, "Coin": 1002}
        """
    ...
    def escrow(self):
        ...
        Example:
            >> self.escrow
            {"Wood": 0, "Stone": 1, "Iron": 2, "Soil": 3, "Coin": 4}
        """
