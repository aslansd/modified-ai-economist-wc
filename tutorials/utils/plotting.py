...
from modified_ai_economist_wc.foundation.entities.landmarks import RedHouse, BlueHouse
from modified_ai_economist_wc.foundation.entities.resources import Wood, Stone, Iron, Soil
...
def breakdown(log, remap_key=None, governance_type=None, vote_count_method=None, episode_length=2000):
    ...
    all_builds = []
    for t, builds in enumerate(log["CommunicateBuild"]):
